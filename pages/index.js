  ...
  return (
    <div className="row justify-content-center">
      <div className="col-sm-11">
        ...
        <p>
          Born in 1990. In 2010-2015, she studied at the Jan Matejko Academy of Fine Arts in Krakow. Her graduation work
          was completed in Prof. Adam Bricken’s studio and the graduation work annex in photography in Tomas Agat
          Błoński’s studio. She works primarily in painting and photography. Her works spring from theoretical
          considerations and are rich in references to traditional painting. The motif of image-curtain which Emilia
          employs is a clear reference to the Renaissance concept of a painting as a window onto the world. The theme of
          opening is replaced with the self-covering image, at once manifesting its physicality. Emilia is interested in
          the materiality of the image, a simple form arising from complex problems.
        </p>
        <div className="row">
        ...
        <div className="row">
          <div className="col-sm-12">
            ...
            <ul className="list-group list-group-flush">
              ...
              <li className="list-group-item">2017 : Lord's favour is no inheritance : Henryk Gallery : Kraków : PL</li>
              ...
              <li className="list-group-item">2017 : Triange : Polnisches Institut Düsseldorf : Düsseldorf : DE</li>
              <li className="list-group-item">
              ...
              <li className="list-group-item">2016 : Song and Dance Ensemble Henryk : Henryk Gallery : Kraków: PL</li>
              <li className="list-group-item">
                2016 : Artists from Kraków. Generation 1980-1990 : Museum of Contemporary Art in Krakow – MOCAK : Kraków
                : PL
              </li>
              ...
              <li className="list-group-item">2015 : Liban : Gallery Of Contemporary Art : Gorzów Wielkopolski : PL</li>
              <li className="list-group-item">
