    ...
    >
      <div className="row justify-content-center">
        <div className="col-sm-11">
          ...
          <p>
            Born in 1990. In 2010-2015, she studied at the Jan Matejko Academy of Fine Arts in Krakow. Her graduation
            work was completed in Prof. Adam Bricken’s studio and the graduation work annex in photography in Tomas Agat
            ...
            employs is a clear reference to the Renaissance concept of a painting as a window onto the world. The theme
            of opening is replaced with the self-covering image, at once manifesting its physicality. Emilia is
            interested in the materiality of the image, a simple form arising from complex problems.
          </p>
          <div className="row">
