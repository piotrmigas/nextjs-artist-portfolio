        ...
        <div className="row justify-content-center">
          <div className="col-sm-11">
            ...
            <p>
              ...
              work was completed in Prof. Adam Bricken’s studio and the graduation work annex in photography in Tomas
              Agat Błoński’s studio. She works primarily in painting and photography. Her works spring from theoretical
              considerations and are rich in references to traditional painting. The motif of image-curtain which Emilia
              employs is a clear reference to the Renaissance concept of a painting as a window onto the world. The
              theme of opening is replaced with the self-covering image, at once manifesting its physicality. Emilia is
